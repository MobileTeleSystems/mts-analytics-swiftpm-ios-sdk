...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "MTSAnalytics",
            url: "https://github.com/MobileTeleSystems/mts-analytics-swiftpm-ios-sdk/releases/download/1.2.0/MTSAnalytics-1.2.0.zip",
            checksum: "4dd5b534c51de5356db4b98b6f44101da723703a402a251e89f967d601b1b0c6"
         )
    ]
)